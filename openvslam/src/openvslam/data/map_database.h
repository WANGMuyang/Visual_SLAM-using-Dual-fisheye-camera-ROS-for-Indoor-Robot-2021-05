...
public:
    ...
    /**
     * Get all of the stations in the database
     * @return
     */
    std::vector<station*> get_all_stations() const;
     ...
     * @return
     */
    unsigned int get_num_stations() const;
     ...
     * @param json_stations
     */
    void to_json(nlohmann::json& json_keyfrms, nlohmann::json& json_landmarks, nlohmann::json& json_stations);
...
private:
     ...
     * @param json_station
     */
    void register_station(const unsigned int id, const nlohmann::json& json_station);
    ...
    //! IDs and landmarks
    std::unordered_map<unsigned int, station*> stations_;
