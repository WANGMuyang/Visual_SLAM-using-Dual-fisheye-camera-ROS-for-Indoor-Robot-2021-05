...
struct CameraParams cam[2];

// cam[0].radius[0] = 425;
// cam[0].centerPos[0] = vec2(478, 478);    initialization must be in main()
// cam[0].rotate[0] = 0.000;

// cam[0].radius[1] = 425;
// cam[0].centerPos[1] = vec2(478, 478);
// cam[0].rotate[1] = 0.000;

// cam[1].radius[0] = 425;
// cam[1].centerPos[0] = vec2(1438, 478);
// cam[1].rotate[0] = 0.000;

// cam[1].radius[1] = 425;
// cam[1].centerPos[1] = vec2(1438, 478);
// cam[1].rotate[1] = 0.000;

const float blendingRatio = 0.99; // 1.0=no alpha blending
const float translate = 0.0;
...
{
    cam[0].radius[0] = 425.0;
    cam[0].centerPos[0] = vec2f(478, 478);
    cam[0].rotate[0] = 0.000;

    cam[0].radius[1] = 425.0;
    cam[0].centerPos[1] = vec2f(478, 478);
    cam[0].rotate[1] = 0.000;

    cam[1].radius[0] = 425.0;
    cam[1].centerPos[0] = vec2f(1438, 478);
    cam[1].rotate[0] = 0.000;

    cam[1].radius[1] = 425.0;
    cam[1].centerPos[1] = vec2f(1438, 478);
    cam[1].rotate[1] = 0.000;
